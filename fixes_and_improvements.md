...
- [x] Добавить ключевые KPI и метрики на дашборд
...
- [x] Вынести проекты в отдельную страницу
...
- [x] После создания проекта переходить внутрь проекта
...
- [x] Вынести продуктовые группы в отдельную страницу
...
- [x] Добавить кнопку «Перейти в группу»
  - На карточке группы сделать понятную кнопку/зону перехода внутрь группы.

- [x] Добавить favicon, логотип и глобальное меню
...
- [x] Улучшить шапку карточки проекта
...
- [x] Добавить в шапку проекта статус-бар
...
- [x] Исправить проблемы с GTM-этапами (создание/обновление)
...
- [x] Сделать ввод характеристик инлайн, без модальных диалогов
...
- [x] Сделать ввод подзадач инлайн
...
- [x] Связать подзадачи с прогрессом задачи
...
- [x] Визуально улучшить задачи и подзадачи
...
- [x] Изменить ввод комментариев на инлайн + текстовый редактор
...
- [x] Добавить раздел/страницу «Шаблоны»
...
- [x] Добавить кастомные поля для GTM-этапов
...
- [x] Ввести короткие цифровые ID для карточек
...
- [x] Пройтись по логам и убедиться, что нет повторяющихся 500 ошибок
...
- [x] Провести регрессионное тестирование ключевых сценариев
