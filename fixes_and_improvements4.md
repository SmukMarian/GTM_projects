...
- [x] Сделать импорт характеристик «полным»
  ...
  - Текущий импорт доработать так, чтобы:
    ...
    - корректно обрабатывались новые и существующие поля (создавать недостающие секции/поля, приводить значения к типу).
...
- [x] Перенести переключатель темы в меню
  - Убрать плавающую кнопку смены темы.
  - Добавить в навигацию выпадающий пункт с эмодзи для выбора светлой, системной или тёмной темы.
