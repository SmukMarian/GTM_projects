# Haier Project Tracker — Дополнительные правки UI/UX (волна 4)
...
- [ ] Перенести комментарии в иконку справа от задачи
...
- [ ] Дать возможность сворачивать задачи
...
- [ ] Упростить чекбокс «Отметить как важную»
...
- [ ] Исправить читаемость ярлыка важности в светлой теме
...
- [ ] Исправить читаемость индикатора риска в светлой теме
...
- [ ] Перевести комментарии к этапам в иконку / вкладку
...
- [ ] Добавить ссылку с дашборда на страницу важных/срочных задач
  - На дашборде добавить блок/карту «Важные и срочные задачи» с ссылкой.

- [ ] Реализовать отдельную страницу со сводкой задач
...
- [ ] Добавлять лейблы характеристик инлайн, без попапов
  - При добавлении нового поля характеристики:
    - вводить Label/Название прямо в строке таблицы;
    - без дополнительных модальных окон для названия поля.
...
- [ ] Убрать/переопределить `width: 100%` на странице характеристик
...
- [ ] Починить типы полей в характеристиках и шаблонах
