# Projects Tracker — AGENTS

## 1. Назначение проекта

Projects Tracker — локальное веб-приложение для личного ведения проектов по запуску новых продуктов на рынок.
...
Агент работает как «главный разработчик» Projects Tracker.
