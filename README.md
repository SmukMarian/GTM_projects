...
- Отдельный блок галереи с квадратными миниатюрами, загрузкой нескольких изображений и сортировкой (кнопки ↑/↓).
- Изображение можно пометить как обложку; остальные отметки обложки сбрасываются автоматически.
