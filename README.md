...
- Отдельная страница «Характеристики» (ссылка в шапке карточки проекта) отображает секции и поля RU/EN рядом, позволяет добавлять/переименовывать/перемещать/удалять секции и поля, редактировать значения, сохранять текущую структуру как шаблон, применять шаблон или копировать структуру из другого проекта, а также импортировать/экспортировать Excel с колонками Секция / Label RU / Label EN / Value RU / Value EN / Тип поля. Контекстное меню работает как для секций, так и для строк полей, значения редактируются инлайн с автосохранением при изменении ячеек.
...
- Отдельная страница «Шаблоны» с перечнем шаблонов GTM-этапов и характеристик, их просмотром, переименованием, удалением и созданием новых.
