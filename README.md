...
- `backend/` — минимальный сервер на FastAPI, сейчас отдаёт health-check и статику, содержит модели данных и настройки путей хранения.
...
Дальнейшие шаги: спроектировать хранилище, реализовать экраны и логику согласно ТЗ, добавить импорт/экспорт и резервное копирование.
