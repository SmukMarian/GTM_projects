...
- **Сводка по фильтру**: интерактивная плашка с количеством задач, долей готовых, просроченных/скоро в сроке и средним прогрессом.
...
- [x] Табличный вид поддерживает инлайн-редактирование статуса и дат, показывая SLA/риск-бейджи и прогресс без модалок.
- [x] Описания и мета-тексты в этапах/задачах адаптированы под переносы строк и мобильную сетку без горизонтального скролла.
- [x] Карточка этапа приведена к упорядоченной сетке: шапка с мета-чипами, компактный блок таймлайна и метрик, боковая панель быстрых действий и статуса, адаптивная "доска задач" на отдельной плашке.
